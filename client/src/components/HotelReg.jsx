...
const HotelReg = () => {
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70'>
        <form className="flex w-full max-w-4xl bg-white rounded-xl overflow-hidden max-h-[90vh]">

          <img src={assets.regImage} alt="reg-image" className='hidden md:block md:w-1/2 object-cover' />
          ...
          <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10 overflow-y-auto">
            ...
            <div>
                ...
                <button className='bg-indigo-500 hover:bg-indigo-600 transition-all text-white px-6 py-2 mt-6 rounded cursor-pointer'>Register </button>
            </div>
          </div>
        </form>
    </div>
