...
const Navbar = () => {
 ...
 useEffect(() => {
  ...
  px-3 sm:px-4 md:px-16 lg:px-24 xl:px-32 
  transition-all duration-500 z-50 ${
    isScrolled
      ? "bg-white/80 shadow-md text-gray-700 backdrop-blur-lg py-2 sm:py-3 md:py-4"
...
>
  ...
  <Link to="/">
    <img
      src={assets.logo}
      alt="Logo"
      className={`h-7 sm:h-8 md:h-9 transition-all duration-300 ${
  ...
  <div className="hidden md:flex items-center gap-4">
    <img
      ...
      alt="search"
      className={`${isScrolled && "invert"} h-6 transition-all duration-500`}
    />
  ...
  <div className="flex items-center gap-3 md:hidden">
    ...
    <img
      ...
      src={assets.menuIcon}
      alt="menu"
      className={`${isScrolled && "invert"} h-5 sm:h-6`}
    />
  </div>
