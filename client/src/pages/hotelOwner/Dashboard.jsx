...
const Dashboard = () => {
 ...
 const {user,axios,getToken,currency,toast} = useAppContext();
  ...
  return (
    <div>
      <Title align="left" font="outfit" title="Dashboard" subTitle="Monitor your room listings,track bookings and analyze revenue-all in one place. Stay updated with real-time insigths to ensure smooth operations."/>
